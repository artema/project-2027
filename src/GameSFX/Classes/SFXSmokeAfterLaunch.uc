class SFXSmokeAfterLaunch expands Effects;
...
auto simulated state Flying
{
	simulated function Tick(float deltaTime)
	{
		...
		if (bFade)
			ScaleGlow = (LifeSpan / OrigLifeSpan) * 0.75;	// this actually sets the alpha from 1.0 to 0.0
	}
...
defaultproperties
{
     ...
     Texture=Texture'GameMedia.Effects.ef_ExpSmoke010'
     DrawScale=0.020000
}
