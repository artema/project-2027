...
// MJ12Commando.
//=============================================================================
class MJ12CommandoTroop extends HumanMilitary;
...
defaultproperties
{
     ...
     MinHealth=0.000000
     CarcassType=Class'Game.MJ12CommandoTroopCarcass'
     WalkingSpeed=0.296000
     bCanCrouch=False
     CloseCombatMult=0.500000
     InitialInventory(0)=(Inventory=Class'Game.WeaponMJ12Mech')
     InitialInventory(1)=(Inventory=Class'DeusEx.RAmmo556mm',Count=24)
     InitialInventory(2)=(Inventory=Class'Game.WeaponMJ12Gauss')
     InitialInventory(3)=(Inventory=Class'DeusEx.RAmmoGas',Count=100)
     InitialInventory(4)=(Inventory=Class'BioelectricCell',Count=1)
     BurnPeriod=0.000000
