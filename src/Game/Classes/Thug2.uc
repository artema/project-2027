...
//=============================================================================
class Thug2 extends HumanThug;

defaultproperties
{
     CarcassType=Class'Game.Thug2Carcass'
     ...
     MultiSkins(0)=Texture'GameMedia.Characters.Thug2Tex0'
     MultiSkins(1)=Texture'DeusExCharacters.Skins.HowardStrongTex2'
     ...
     MultiSkins(7)=Texture'GameMedia.Characters.Thug2Tex0'
