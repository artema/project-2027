//=============================================================================
// ���� "����� ����". �������� Ded'�� ��� ���� 2027
// "New Game" screen. Copyright (C) 2003 Ded
//=============================================================================
class GameMenuScreenNewGame expands MenuUIScreenWindow;
...
//ToolListWindow
//MenuUIListWindow
var GameUISkillInfoWindow    winSkillInfo;
...
event InitWindow()
{
	...
	DeusExPlayer(GetPlayerPawn()).ResetPlayer();
...
{
	editCodeName = CreateMenuEditWindow(18, 36, 113, 32, winClient);//18-30
...
{
	editName = CreateMenuEditWindow(18, 92, 113, 32, winClient);//18-86

	editName.SetText(player.DefaultTruePlayerName);
...
function CreateSkillsListWindow()
{
	...
	lstSkills.SetSize(397, 169);//397-150
	lstSkills.SetPos(172,36);//172-41
	lstSkills.EnableMultiSelect(False);
	lstSkills.EnableAutoExpandColumns(True);
...
{
	winSkillInfo = GameUISkillInfoWindow(winClient.NewChild(Class'GameUISkillInfoWindow'));
	winSkillInfo.SetPos(165, 168);
}
...
defaultproperties
{
     ...
     texPortraits(0)=Texture'GameMedia.Icons.NewGameDaniel_1'
     texPortraits(1)=Texture'GameMedia.Icons.NewGameDaniel_2'
     texPortraits(2)=Texture'GameMedia.Icons.NewGameDaniel_3'
