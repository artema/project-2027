...
class GameUISkillInfoWindow expands Window;
...
event StyleChanged()
{
	...
	colSkillName = theme.GetColorFromName('MenuColor_ButtonTextFocus');
	colSkillDesc = theme.GetColorFromName('MenuColor_ButtonTextFocus');
