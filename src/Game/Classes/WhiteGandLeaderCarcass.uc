//=============================================================================
// Тело - Лидер белой банды. Сделанно Ded'ом для мода 2027
// Corpse - White gang leader. Copyright (C) 2003 Ded
//=============================================================================
class WhiteGandLeaderCarcass extends DeusExCarcass;
...
defaultproperties
{
     ...
     MultiSkins(5)=Texture'DeusExCharacters.Skins.JanitorTex1'
