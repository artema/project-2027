...
class GameMenuScreenHUD expands MenuUIScreenWindow;
...
defaultproperties
{
     choices(0)=Class'DeusEx.MenuChoice_MenuColor'
     choices(1)=Class'DeusEx.MenuChoice_HUDColor'
     choices(2)=Class'DeusEx.MenuChoice_MenuTranslucency'
     choices(3)=Class'DeusEx.MenuChoice_HUDTranslucency'
     choices(4)=Class'DeusEx.MenuChoice_HUDBordersVisible'
     choices(5)=Class'DeusEx.MenuChoice_UIBackground'
