//=============================================================================
// Тело - Парень. Сделанно Ded'ом для мода 2027
// Corpse - Generic male. Copyright (C) 2005 Ded
//=============================================================================
class GenericMale1Carcass extends DeusExCarcass;
...
defaultproperties
{
     ...
     MultiSkins(4)=Texture'DeusExCharacters.Skins.NathanMadisonTex0'
