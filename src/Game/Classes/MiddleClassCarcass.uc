//=============================================================================
// Тело - Средний класс. Сделано Ded'ом для мода 2027
// Corpse - Middle class. Copyright (C) 2003 Ded
//=============================================================================
class MiddleClassCarcass extends DeusExCarcass;
...
defaultproperties
{
     ...
     MultiSkins(2)=Texture'DeusExCharacters.Skins.PantsTex6'
