//=============================================================================
// Тело - Машинист. Сделанно Ded'ом для мода 2027
// Corpse - Metro pilot. Copyright (C) 2003 Ded
//=============================================================================
class MetroPilotCarcass extends DeusExCarcass;
...
defaultproperties
{
     ...
     MultiSkins(3)=Texture'DeusExCharacters.Skins.JanitorTex1'
     MultiSkins(4)=Texture'DeusExCharacters.Skins.JanitorTex1'
