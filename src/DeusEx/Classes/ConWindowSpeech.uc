...
var localized Color colConTextNormal;
var localized Color colConTextPlayer;
var localized Color colConTextName;
...
function SetSpeech(String newSpeech, optional Actor speakingActor, optional bool bHighlight)
{
	if (newSpeech == "")
	{
		txtSpeech.SetText("");
	...
	else
	{
		...
		if ((speakingActor != None) && (DeusExPlayer(speakingActor) != None) || bHighlight)
...
defaultproperties
{
     ...
     colConTextPlayer=(R=180,G=180,B=255)
     colConTextName=(R=255,G=255,B=255)
}
