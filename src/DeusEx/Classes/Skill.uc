...
defaultproperties
{
     skillLevelStrings(0)="Новичок"
     skillLevelStrings(1)="Стажер"
     skillLevelStrings(2)="Опытный"
     skillLevelStrings(3)="Мастер"
     SkillAtMaximum="Навык на максимальном уровне"
     bHidden=True
     bTravel=True
     ...
     LevelValues(2)=0.0
     LevelValues(3)=0.0
     AltLevelValues(0)=0.0
     AltLevelValues(1)=0.0
     AltLevelValues(2)=0.0
     AltLevelValues(3)=0.0
}
