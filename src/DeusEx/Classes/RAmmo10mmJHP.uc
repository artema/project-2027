//=============================================================================
// ��������� - 10�� JHP �������. �������� Ded'�� ��� ���� 2027
// Ammo - 10mm JHP rounds. Copyright (C) 2003 Ded 
// ����� ������/Model created by: Ded
// Deus Ex: 2027
//=============================================================================
class RAmmo10mmJHP extends DeusExAmmo;
...
function bool UpdateExistence()
{
	...
	{
		if(AmmoType == ET_Crate || FRand() <= 0.5) return false;
	}
...
{
     bIsNonStandard=True
     RealMesh1=LodMesh'GameMedia.10mmJHPBox'
     RealMesh2=LodMesh'GameMedia.10mmJHPCrate'
     RealMesh3=LodMesh'GameMedia.10mmJHP'
     bShowInfo=True
     AmmoAmount=10
     MaxAmmo=180
     PickupViewMesh=LodMesh'GameMedia.10mmJHPBox'
     Icon=Texture'GameMedia.Icons.BeltIcon10mmJHP'
     largeIcon=Texture'GameMedia.Icons.LargeIcon10mmJHP'
     largeIconWidth=46
     largeIconHeight=32
     Mesh=LodMesh'GameMedia.10mmJHPBox'
