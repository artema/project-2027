...
defaultproperties
{
     ...
     ButtonLabelWithdraw="|&Снять"
     ButtonLabelClose="|&Закрыть"
     BalanceLabel="Текущий баланс:"
     WithdrawAmountLabel="Снять сумму:"
     InstructionText="Счет #: %d|nВведите колличество денег,|nкоторое вы хотите снять."
     InvalidAmountLabel="НЕВЕРНАЯ СУММА"
     InsufficientCreditsLabel="НЕ ХВАТАЕТ ДЕНЕГ"
     CreditsWithdrawnLabel="ДЕНЬГИ СНЯТЫ"
     StatusText="TMPLR//PUB:9811.1575[WD]"
     HackedText="ТЕРМИНАЛ ВЗЛОМАН"
     escapeAction="LOGOUT"
     ...
     bAlwaysCenter=True
     statusPosY=186
     ComputerNodeFunctionLabel="Терминал"
}
