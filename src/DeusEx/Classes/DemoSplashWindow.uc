...
function DrawWindow(GC gc)
{
	...
	gc.DrawIcon(  0,   0, Texture'BlackMaskTex');
	gc.DrawIcon(256,   0, Texture'BlackMaskTex');
	gc.DrawIcon(512,   0, Texture'BlackMaskTex');
	gc.DrawIcon(  0, 256, Texture'BlackMaskTex');
	gc.DrawIcon(256, 256, Texture'BlackMaskTex');
	gc.DrawIcon(512, 256, Texture'BlackMaskTex');
}
