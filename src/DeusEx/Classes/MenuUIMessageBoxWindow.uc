...
defaultproperties
{
     fontHeader=Font'DeusExUI.FontMenuHeaders'
     fontMessage=Font'DeusExUI.FontFixedWidthSmall_DS'
     textBorderX=20
     textBorderY=14
     btnLabelYes="|&Да"
     btnLabelNo="|&Нет"
     btnLabelOK="|&OK"
     btnLabelCancel="|&Отмена"
     ClientWidth=280
     ClientHeight=85
