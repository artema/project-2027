...
defaultproperties
{
     AccountLabel="Счет #:"
     PinLabel="PIN #:"
     LoginInfoText="Введите номер вашего счета и PIN-Код"
     WarningText="ВНИМАНИЕ: Неавторизированный доступ будет встречен жестким силовым воздействием!"
     StatusText="TMPLR//PUB:9811.1575[login]"
     InvalidLoginMessage="ОШИБКА ЛОГИНА, ДОСТУП ЗАПРЕЩЕН"
