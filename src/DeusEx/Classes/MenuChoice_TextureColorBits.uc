...
defaultproperties
{
     ...
     RestartTitle="Глубина цвета"
     RestartMessage="Эти изменения вступят в силу после перезагрузки 2027."
     helpText="Определяет глубину цвета текстур. 32-битные текстуры выглядят лучше, если оборудование их поддерживает."
     actionText="|&Глубина цвета текстур"
     enumText(0)="16-бит"
     enumText(1)="32-бит"
     defaultInfoWidth=98
