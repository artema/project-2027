...
function CreateBioWindows()
{
	...
	winBioBarText.SetFont(fontText);
...
function CreateRepairbotWindows()
{
	...
	winRepairBotBarText.SetFont(fontTextInfo);
...
defaultproperties
{
     fontText=Font'FontMenuSmall_DS'
     fontTextInfo=Font'FontMenuSmall'
     ...
     RechargeButtonLabel="|&Использовать"
     CloseButtonLabel="|&Закрыть"
     RechargeTitle="Ремонтный бот"
     RepairBotInfoText="Ремонтный бот может восстановить до %d единиц био-энергии каждые %d секунд."
     RepairBotStatusLabel="Статус:"
     ReadyLabel="Готово!"
     SecondsPluralLabel="Подзарядка: %d секунд"
     SecondsSingularLabel="Подзарядка: %d секунда"
     BioStatusLabel="Энергия:"
     RepairBotRechargingLabel="|n|nРемонтный бот заряжается, подождите."
     RepairBotReadyLabel="|n|nРемонтный бот готов к использованию."
     RepairBotYouAreHealed="|n|nВаша био-энергия на максимуме."
     ScreenType=ST_Popup
}
