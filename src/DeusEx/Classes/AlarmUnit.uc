...
function Tick(float deltaTime)
{
	...
	if (bConfused)
	{
		...
		if (FRand() > 0.95)
			MultiSkins[1] = Texture'GameMedia.Skins.AlarmTex1';
		else
			MultiSkins[1] = Texture'PinkMaskTex';
...
defaultproperties//AlarmTex1
{
     alarmTimeout=30
     msgActivated="Сигнализация включена"
     msgDeactivated="Сигнализация выключена"
     confusionDuration=10.000000
     HitPoints=50
     minDamageThreshold=50
     bInvincible=False
     ItemName="Панель Звуковой Сигнализации"
