...
defaultproperties
{
     ...
     HackButtonLabel="|&Âçëîì"
     ReturnButtonLabel="|&Íàçàä"
     HackReadyLabel="Ëåäîðóá ãîòîâ..."
     HackInitializingLabel="Èíèöèàëèçàöèÿ ëåäîðóáà..."
     HackSuccessfulLabel="Ëåä âçëîìàí..."
     HackDetectedLabel="*** ÂÍÈÌÀÍÈÅ ***|nÎÁÍÀÐÓÆÅÍ ÍÀÐÓØÈÒÅËÜ!"
     MPHackInitializingLabel="Âçëîì... Íàæìèòå ESC äëÿ îòìåíû"
     backgroundWidth=187
     backgroundHeight=94
     backgroundPosX=14
     backgroundPosY=13
